...
IPEDS_2016$CIPDESC <- IPEDS_2016$CIPCODE %>% plyr::mapvalues(from = CIP_mapping$CIP_code, to = CIP_mapping$CIP_name)

home_institution_programs <- IPEDS_2016 %>% filter(IPEDS_2016$UNITID %in% home_institution)



#prog_completion <- IPEDS_2016 %>% select("UNITID","CIPCODE","MAJORNUM","CIPCODE","AWLEVEL","CTOTALT")
prog_completion <- IPEDS_2016

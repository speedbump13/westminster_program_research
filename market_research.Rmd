...
institutions_2016_utah <- filter(open_institutions_2016, STABBR %in% market_state)
institutions_2016_peer <- filter(open_institutions_2016, UNITID %in% market_peer_inst)
...
onlineprogs_2016 <- read.csv("~/westminster_program_research/IPEDS/C2016DEP.txt")
```
